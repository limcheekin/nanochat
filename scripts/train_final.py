...
def main():
    ...
    # === CORRECTED MODEL INITIALIZATION: NO WRAPPERS OR PATCHES ===
    ...
    # The UnslothTrainer will handle the performance patching automatically.
    ...
    # It will automatically apply the necessary performance patches.
    trainer = UnslothTrainer(
        model=model,
        tokenizer=None, # Dataset is already tokenized
        args=training_args,
